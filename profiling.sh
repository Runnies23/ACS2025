...
#SBATCH --output=/mnt/%u/unifolm-wma-0-dual_run_workspace/%j_profiling.out
...
export PYTHONPATH="/mnt/ASC1664/unifolm-wma-0-dual_run_workspace/unifolm-world-model-action/src:$PYTHONPATH"
...
ckpt=./ASC26-Embodied-World-Model-Optimization/ckpts/unifolm_wma_dual.ckpt
config=./unifolm-world-model-action/configs/inference/world_model_interaction.yaml
res_dir="/mnt/$USER/results/run"
seed=123
model_name=testing

...
from unifolm_wma_run.utils.common import autocast
from unifolm_wma_run.utils.utils import count_params
from unifolm_wma_run.modules.encoders.resampler import reshape_tensor
...
class FrozenOpenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self,
        ...
        checkpoint = torch.load('/mnt/ASC1664/run_workspace/weight_clip/open_clip_pytorch_model.bin', 
                        map_location='cpu')

        # model, _, _ = open_clip.create_model_and_transforms(
        #     arch, device=torch.device('cuda'), pretrained=None)
        # checkpoint = torch.load('/mnt/ASC1664/unifolm-wma-0-dual/weight_clip/open_clip_pytorch_model.bin', 
        #                 map_location='cuda')
...
class FrozenOpenCLIPImageEmbedderV2(AbstractEncoder):
    ...
    def __init__(self,
        ...
        #     pretrained=None,
        # )
        # checkpoint = torch.load('/mnt/ASC1664/unifolm-wma-0-dual_run_workspace/weight_clip/open_clip_pytorch_model.bin', 
        #                 map_location='cuda')

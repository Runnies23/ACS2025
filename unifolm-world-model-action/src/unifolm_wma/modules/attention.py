...
class CrossAttention(nn.Module):
    ...
    def efficient_forward(self, x, context=None, mask=None):
        ...
        if k is not None:
            ...
            out = safe_attention(q, k, v, attn_bias=None)
        ...
        if k_ip is not None:
            ...
            out_ip = safe_attention(q, k_ip, v_ip, attn_bias=None)
        ...
        if k_as is not None:
            ...
            out_as = safe_attention(q, k_as, v_as, attn_bias=None)
        ...
        if k_aa is not None:
            ...
            out_aa = safe_attention(q, k_aa, v_aa, attn_bias=attn_mask_aa)

...
#SBATCH --output=/mnt/ASC1664/unifolm-wma-0-dual/ASC26-Embodied-World-Model-Optimization/%j.out
...
BASE_DIR="/mnt/ASC1664/unifolm-wma-0-dual/ASC26-Embodied-World-Model-Optimization/unitree_z1_dual_arm_cleanup_pencils"
